...
var = input("Donnez une valeur a var : ")
...
if re.search (r"^.?$", var):
    ...
    print (" var contient plus dun caractere ")
...
if re.search(r"^[^@]+@[^@]+\.[^@]+$", var):
    print ("var est un courriel valide")
else :
    print ("var nest pas un courriel valide")
if re.search (r"(?=[^a-z]*[a-z])(?=[^\d]*\d{3})", var):
    print (" var contient une lettre et trois chiffres de suite ( peu importe l’ordre )")
else :
    print (" var ne contient pas de lettre ou trois chiffres de suite ")